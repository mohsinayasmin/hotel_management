...
@section('content')
                ...
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            ...
                            <div class="stat-digit">{{App\Models\Booking::count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            ...
                            <div class="stat-digit">{{App\Models\Customer::count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            ...
                            <div class="stat-digit">{{App\Models\Room::count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="stat-widget-one card-body">
                        ...
                        <div class="stat-content d-inline-block">
                            ...
                            <div class="stat-digit">{{App\Models\Staff::count()}}</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        var _lebels = {!! json_encode($lebels) !!};
