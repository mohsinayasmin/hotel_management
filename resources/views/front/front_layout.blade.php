                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">{{Auth::user()->full_name}}</a>
                        ...
                        @else
                        <a href="{{route('user_login')}}" class="nav-item nav-link">Log In</a>
                        <a href="{{route('user_register')}}" class="nav-item nav-link">Reigister</a>
                        @endif
    ...
    <div class="container-fluid bg-dark text-white border-top py-4 px-sm-3 px-md-5" style="border-color: rgba(256, 256, 256, .1) !important;">
        <div class="row">
            <div class="col-lg-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white-50"> <a href="{{ url('/login') }}"> Admin Login </a>
                </p>
            </div>
